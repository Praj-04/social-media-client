...
function Profile() {
  ...
  const params = useParams(); //sending userid as params
  ...
  }, [dispatch,myProfile , params.userId,feedData]); //dispatch added here
      ...
      <div className="container">
        ...
        <div className="right-part">
          <div className="profile-card">
            ...
            {/* if I am in other person's profile..then show follow button */}
            ...
            {/* if it is my profile,then show followers */}
